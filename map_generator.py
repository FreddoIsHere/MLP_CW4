...
parser.add_argument('--num_obstacles', nargs="?", type=int, default=0, help='number of obstacles per map')
parser.add_argument('--max_obstacle_size', nargs="?", type=int, default=0, help='obstacle size')
parser.add_argument('--min_obstacle_size', nargs="?", type=int, default=0, help='obstacle size')
