...
parser.add_argument('--max_obstacle_size', nargs="?", type=int, default=6, help='obstacle size')
parser.add_argument('--min_obstacle_size', nargs="?", type=int, default=3, help='obstacle size')
